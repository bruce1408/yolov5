...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5s.yaml', help='/mnt/share_disk/bruce_trie/yolov5/models/yolov5m.yaml')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default="/mnt/share_disk/bruce_trie/yolov5/save_models/train/train_log7/weights/last.pt", help='resume most recent training')
    ...
    parser.add_argument('--project', default=ROOT / 'save_models/train', help='save to project/name')
    parser.add_argument('--name', default='train_log', help='save to project/name')
